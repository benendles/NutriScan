...
class LogFoodAdapter(private val items: List<FoodEntry>) :
    RecyclerView.Adapter<LogFoodAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(h: ViewHolder, i: Int) {
        val item = items[i]; h.b.tvFoodEmoji.text = item.emoji; h.b.tvFoodName.text = item.name
